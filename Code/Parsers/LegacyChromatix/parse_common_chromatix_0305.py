# -*- coding: utf-8 -*-
"""
Parser chromatix VFE common 0x0305.

Structures based on chromatix_0305.h and chromatix_common_0305.h:
- In 0x0305, the top type chromatix_VFE_common_type contains:
